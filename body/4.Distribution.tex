...
正态分布的密度函数$f(x)$的图形如图\ref{fig2.5.1}(a)所示，是一条钟形曲线，左右关于$\mu$对称，衰减速度由$\sigma$决定，$\mu\pm\sigma$是该曲线的拐点。
\begin{itemize}
